                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="banner-slider">
                        <div class="banner-slider-inner">
                            <img src="{{asset('')}}clients/assets/slider-1.jpeg" alt="" />
                        </div>
                        <div class="banner-slider-inner">
                            <img src="{{asset('')}}clients/assets/slider-2.jpeg" alt="" />
                        </div>
                        <div class="banner-slider-inner">
                            <img src="{{asset('')}}clients/assets/slider-3.jpeg" alt="" />
                        </div>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3">
                    <div class="banner-right">
                        <div class="banner-right__img">
                            <img src="{{asset('')}}clients/assets/banner.png" alt="" />
                        </div>
                        <div class="banner-right__img">
                            <img src="{{asset('')}}clients/assets/banner.png" alt="" />
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="d-flex course">
                        <div class="banner-course">
                            <img src="{{asset('clients/assets/banner-course.png')}}" alt="" />
                        </div>
                        <div class="descreption-course">
                            ...
                            <div class="descreption-teacher">
                                <img src="{{asset('clients/assets/course-teacher.png')}}" alt="" />
            ...
            <div class="row">
                <div class="col-6 col-lg-3">
                    <div class="partner-img">
                        <img src="{{asset('')}}clients/assets/partner.jpeg" alt="" />
                    </div>
                </div>
                <div class="col-6 col-lg-3">
                    <div class="partner-img">

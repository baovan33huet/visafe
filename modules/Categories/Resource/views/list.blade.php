...
@section('content')
    ...
    @endif
    <div class="border">
        <h2 class="text-center pt-3 font-weight-bold pb-2 border-bottom">LISR CATEGORIES! </h2>
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <p class="text-right" style="margin-top: 4px;">
                    <a href="{{route('admin.categories.create')}}" class="btn btn-primary mr-3">Add New Category</a>
                </p>
            </div>
        </div>
    </div>
                ...
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                <th class="">Name</th>
                                <th class="">Time</th>
                                <th class="" style="width: 5%;">Link</th>

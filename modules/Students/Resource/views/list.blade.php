...
@section('content')
    ...
    @endif
    <div class="border">
        <h2 class="text-center pt-3 font-weight-bold pb-2 border-bottom">LIST STUDENTS! </h2>
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <p class="text-right" style="margin-top: 4px;">
                    <a href="{{route('admin.students.create')}}" class="btn btn-primary mr-3">Add New Student</a>
                </p>
            </div>
        </div>
    </div>

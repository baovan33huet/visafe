<ul style="border: 0;" class="nav nav-pills flex-column border border-primary rounded">
    ...
    <li class="nav-item"><a class="nav-link {{activeMenu('students.account.edit-profile') ? 'active': ''}}" href="{{route('students.account.edit-profile')}}">Cập nhập thông tin</a></li>
